...
const Dashboard = () => {
  ...
  // Mostrar carga mientras se inicializa la autenticación
  if (authLoading) {
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-6 py-8">
          <div className="mb-8">
            <h1 className="text-4xl font-medium text-gray-900 mb-2">Bienvenido a HorusLM</h1>
          </div>
  ...
  // Mostrar estado de carga de cuadernos
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <DashboardHeader userEmail={user?.email} />
  ...
  // Mostrar error de cuadernos si existe
  if (isError && error) {
    return (
      <div className="min-h-screen bg-gray-50">
        <DashboardHeader userEmail={user?.email} />
        <main className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="text-center py-16">
            <p className="text-red-600">Error al cargar cuadernos: {error}</p>
            <button 
              onClick={() => window.location.reload()} 
              className="mt-4 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"
            >
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-[60px]">
        <div className="mb-8">
          <h1 className="font-medium text-gray-900 mb-2 text-5xl">Bienvenido a HorusLM</h1>
        </div>
